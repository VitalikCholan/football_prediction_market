...
export const BUY1X2_DISCRIMINATOR = new Uint8Array([68, 164, 198, 241, 230, 145, 96, 214]);
...
export type Buy1x2InstructionDataArgs = { outcome: number; usdtIn: number | bigint; minTokensOut: number | bigint;  };

export function getBuy1x2InstructionDataEncoder(): FixedSizeEncoder<Buy1x2InstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['outcome', getU8Encoder()], ['usdtIn', getU64Encoder()], ['minTokensOut', getU64Encoder()]]), (value) => ({ ...value, discriminator: BUY1X2_DISCRIMINATOR }));
}

export function getBuy1x2InstructionDataDecoder(): FixedSizeDecoder<Buy1x2InstructionData> {
...
export function getBuy1x2InstructionDataCodec(): FixedSizeCodec<Buy1x2InstructionDataArgs, Buy1x2InstructionData> {
...
export function parseBuy1x2Instruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedBuy1x2Instruction<TProgram, TAccountMetas> {
